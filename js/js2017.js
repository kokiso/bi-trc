  ...
  js.campos.forEach(function(c){
    ...
    */
    ...
    cePar.className       = "frmCampo"; 
      ...
      switch( c.type ){
        case 'date'     : ceInp.type= "text";break;
        case 'text'     : ceInp.type= "text";break;
        case 'textarea' : 
          ceInp.type= "textarea";
          ...
          ceInp.cols="35";
          break;
        case 'integer'  : ceInp.type= "text";break;
        case 'password' : ceInp.type= "password";break;
      };  
      ceInp.name        = c.name; 
      ceInp.id          = c.name; 
...
function fncExcel(divCe,novoPadrao){
  ...
  criarEl("input",{
    ...
    ,style   : "height:3.6em !important;"},{appChild:"divBtn"});
...
function segundosEm( parSeg,parRet ){  
  ...
  var sDia  = "00";  
  switch( parRet ){
    case "dddhms"   : var sDia  = "000";         break;
    case "ddddhms"  : var sDia  = "0000";         break;
  };  
  ...
  switch( parRet ){
    case "%ddhms"   : return sDia+"d:"+sHor+"h:"+sMin+"m:"+sSeg+"s";  break;
    case "%hm,s"    : return sHor+"h:"+sMin+"m:"+sSeg+"s";            break;
    case "%ms"      : return sMin+"m:"+sSeg+"s";                      break;
    case "ddhms"    : return sDia+":"+sHor+":"+sMin+":"+sSeg;         break;
    case "dddhms"   : return sDia+":"+sHor+":"+sMin+":"+sSeg;         break;
    case "ddddhms"  : return sDia+":"+sHor+":"+sMin+":"+sSeg;         break;    
    case "hms"      : return sHor+":"+sMin+":"+sSeg;                  break;
    case "ms"       : return sMin+":"+sSeg;                           break;
  };
};
