<?php
  session_start();
  if( isset($_POST["grdProdutividademot"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["grdProdutividademot"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="detalhe" ){
          ...
          $sql.="   AND (A.BIPRD_CODMTR='".$lote[0]->codmtr."')";  
          //$sql.=$frota;
          //$sql.=$turno;          
          $sql.="   AND (COALESCE(UU.UU_ATIVO,'')='S')";   
          //
...
<!DOCTYPE html>
  <head>
    ...
    <title>Produtividade/motorista</title>
    ...
    <script>
        ...
        jsBi={
          "titulo":[
            ...
            ,{"id":11 ,"labelCol"       : "POLO"
                      ...
                      ,"ordenaColuna"   : "S"
                      ,"padrao":0}
            ,{"id":12 ,"labelCol"       : "PRDINI"
                      ,"fieldType"      : "int"
                      ,"align"          : "center"                                      
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
                      ,"padrao":0}
            ,{"id":13 ,"labelCol"       : "PRDFIM"
                      ,"fieldType"      : "int"
                      ,"align"          : "center"                                      
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
                      ,"padrao":0}
            ,{"id":14 ,"labelCol"       : "INT_RODANDO"
                      ,"fieldType"      : "int"
                      ,"align"          : "center"                                      
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
                      ,"padrao":0}
            ,{"id":15 ,"labelCol"       : "INT_PARADO"
                      ,"fieldType"      : "int"
                      ,"align"          : "center"                                      
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
      ...
      function btnFiltrarClick() { 
        ...
        fd = new FormData();
        fd.append("grdProdutividademot" , clsJs.fim());
        msg     = requestPedido("Trac_grdProdutividadeMot.php",fd); 
      ...
      function biDetalheClick(){
        ...
        try{        
          ...
          if( chkds[0].MES==0 ){
            ...
            fd          = new FormData();
            fd.append("grdProdutividademot" , clsJs.fim()); 
            var req = requestPedido("Trac_grdProdutividadeMot.php",fd);
                ...
                jsDet={
                  "titulo":[
                    ...
                    ,{"id":15 ,"labelCol"       : "DATAGPSFIM"
                              ...
                              ,"excel"          : "S"                              
                              ,"padrao":0}
                    ,{"id":16 ,"labelCol"       : "HORAGPSFIM"
                              ,"fieldType"      : "str"
                              ,"tamGrd"         : "7em"
                              ,"tamImp"         : "30"
                              ,"excel"          : "S"                              
                              ,"padrao":0}
                    ,{"id":17 ,"labelCol"       : "LOCFIM"
                              ,"fieldType"      : "str"
                              ,"tamGrd"         : "20em"
                              ,"tamImp"         : "30"
                              ,"excel"          : "S"                              
                              ,"padrao":0}
                    ,{"id":18 ,"labelCol"       : "UNIDADE"
                              ,"fieldType"      : "str"
                              ,"tamGrd"         : "10em"
                              ,"tamImp"         : "25"
                              ,"excel"          : "S"
  ...
  <body>
    <div id="divCabec" class="comboSobreTable" style="margin-top:5px;float:left;">
      ...
      <?php $mesAtualPipe=true; include 'classPhp/comum/selectMes.class.php';?>
