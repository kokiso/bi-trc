  ...
  try{     
    ...
    do{
      ...
      if( $continua ){
        ...
        ///////////////////////////////////////////////////////////////////////////////////////
        $retCls=$classe->selectAssoc("SELECT UI_CODIGO,UI_INTEGRAR,UI_QTOS,UI_CLIENTE,UI_LOGIN,UI_SENHA FROM ULTIMOID");
        if( $retCls['retorno'] != "OK" ){  
        ...
        if( $continua ){
          ...
          //$opcoes     = array('location' => 'http://wsgslog.globalsearch.com.br/V20160/posicoes.asmx');
          $parametros = array ([
            'EmpCliente'        => $retCls["dados"][0]["UI_CLIENTE"] //$empCliente
            ,'Login'            => $retCls["dados"][0]["UI_LOGIN"] //$login 
            ,'Senha'            => $retCls["dados"][0]["UI_SENHA"] //$senha
            ,'Id_Posicao'       => $ultimoId
            ,'ObterLocalizacao' => false
          ]);  
          try{
        ...
        if( $continua ){        
          ...
          foreach($lista as $arq){
            ...
            //if( $mvmPosicao>0 ){
            //  $idFim    = $mvmPosicao;
            //  $ultimoId = ($idFim+1);   //Se o loop $qtos for maior que 1
            //};
            ////////////////
            // Id_Veiculo //
            ////////////////
            ...
            if( ($mvmDesEve=="-") or ($mvmDesEve=="")  ){
              ...
              $mvmDesEve=tirarAcentos($mvmDesEve);      
          ...
          if( count($arrUpdt) == 0 ){
            ...
            $sql="INSERT INTO MOVIMENTORESUMO("
                  ."MR_POSICAOINI"
                  .",MR_POSICAOFIN"
                  .",MR_INICIO"
                  .",MR_FIM"
      ...
      echo "AGUARDANDO PROXIMO CICLO 20segs\r\n";
      sleep($ciclo);
    } while (true);
  } catch(Exception $e ){
    $retorno='[{"retorno":"ERR","dados":"","erro":"cURL Error #:'.$e->getMessage().'"}]';  
  };    
?>