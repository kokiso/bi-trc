GO
ALTER TRIGGER [dbo].[TRGViewTMPMOVIMENTO_BI] ON [dbo].[VTMPMOVIMENTO]
INSTEAD OF INSERT 
AS
BEGIN
	...
	IF( @@rowcount=0 ) BEGIN
      ...
      IF( @varCodMtr=0 ) BEGIN
        ...
        INSERT INTO dbo.VMOTORISTA( 
          MTR_CODIGO  ,MTR_NOME    ,MTR_RFID ,MTR_CODUNI,MTR_ATIVO ,MTR_REG,MTR_CODUSR) VALUES(
          @varCodMtr  ,@mvmDesMtr  ,@mvmRfid ,@mvmCodUni,'S'       ,'P'    ,1
        );
      END
      --
      --
