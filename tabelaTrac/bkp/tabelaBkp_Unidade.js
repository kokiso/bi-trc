function fBkp_Unidade(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpUni={
      ...
      ,"relTitulo"      : "ESPIAO - UNIDADE"              // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpUni === undefined ){          
      objBkpUni=new clsTable2017("objBkpUni");
    };  
    objBkpUni.montarHtmlCE2017(jsBkpUni);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpUni.registros=objBkpUni.addIdUnico(retPhp[0]["dados"]);
    objBkpUni.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpUni.tbl).colAlterada();
  };  
};