function fBkp_EventoGrupo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEg={
      ...
      ,"relTitulo"      : "ESPIAO - GRUPOEVENTO"  // Titulo do relatório
      ,"relOrientacao"  : "R"                     // Paisagem ou retrato
      ,"relFonte"       : "8"                     // Fonte do relatório
      ,"indiceTable"    : "ID"                    // Indice inicial da table
      ,"tamBotao"       : "15"                    // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEg === undefined ){          
      objBkpEg=new clsTable2017("objBkpEg");
    };  
    objBkpEg.montarHtmlCE2017(jsBkpEg);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEg.registros=objBkpEg.addIdUnico(retPhp[0]["dados"]);
    objBkpEg.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEg.tbl).colAlterada();
  };  
};