function fBkp_Motorista(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpMtr={
      ...
      ,"relTitulo"      : "ESPIAO - MOTORISTA"            // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpMtr === undefined ){          
      objBkpMtr=new clsTable2017("objBkpMtr");
    };  
    objBkpMtr.montarHtmlCE2017(jsBkpMtr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpMtr.registros=objBkpMtr.addIdUnico(retPhp[0]["dados"]);
    objBkpMtr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpMtr.tbl).colAlterada();
  };  
};