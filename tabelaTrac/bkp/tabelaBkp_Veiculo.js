function fBkp_Veiculo(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpVcl={
      ...
      ,"relTitulo"      : "ESPIAO - VEICULO"              // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpVcl === undefined ){          
      objBkpVcl=new clsTable2017("objBkpVcl");
    };  
    objBkpVcl.montarHtmlCE2017(jsBkpVcl);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVcl.registros=objBkpVcl.addIdUnico(retPhp[0]["dados"]);
    objBkpVcl.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVcl.tbl).colAlterada();
  };  
};