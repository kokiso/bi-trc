function fBkp_Grupo(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpGrp={
      ...
      ,"relTitulo"      : "ESPIAO - GRUPO"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpGrp === undefined ){          
      objBkpGrp=new clsTable2017("objBkpGrp");
    };  
    objBkpGrp.montarHtmlCE2017(jsBkpGrp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpGrp.registros=objBkpGrp.addIdUnico(retPhp[0]["dados"]);
    objBkpGrp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpGrp.tbl).colAlterada();
  };  
};