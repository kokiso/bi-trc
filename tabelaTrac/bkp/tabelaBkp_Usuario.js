function fBkp_Usuario(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpUsr={
      ...
      ,"relTitulo"      : "ESPIAO - USUARIO"  // Titulo do relatório
      ,"relOrientacao"  : "P"                 // Paisagem ou retrato
      ,"relFonte"       : "8"                 // Fonte do relatório
      ,"indiceTable"    : "ID"                // Indice inicial da table
      ,"tamBotao"       : "12"                // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpUsr === undefined ){          
      objBkpUsr=new clsTable2017("objBkpUsr");
    };  
    objBkpUsr.montarHtmlCE2017(jsBkpUsr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpUsr.registros=objBkpUsr.addIdUnico(retPhp[0]["dados"]);
    objBkpUsr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpUsr.tbl).colAlterada();
  };  
};