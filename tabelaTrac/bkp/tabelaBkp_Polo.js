function fBkp_Polo(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPol={
      ...
      ,"relTitulo"      : "ESPIAO - POLO"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPol === undefined ){          
      objBkpPol=new clsTable2017("objBkpPol");
    };  
    objBkpPol.montarHtmlCE2017(jsBkpPol);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPol.registros=objBkpPol.addIdUnico(retPhp[0]["dados"]);
    objBkpPol.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPol.tbl).colAlterada();
  };  
};