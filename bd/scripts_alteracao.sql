...
-- TENTANDO MELHORAR A PERFORMANCE DA PESQUISA DE MOTORISTAS
create index MOTORISTA_MTR_NOME_index
	on MOTORISTA (MTR_NOME)
go

create index MOTORISTA_MTR_RFID_index
	on MOTORISTA (MTR_RFID)
go
